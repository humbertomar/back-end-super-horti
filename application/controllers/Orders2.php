...
class Orders2 extends Admin_Controller 
{
	var $currency_code = '';
	...
	*/
	public function index()
	{
		...
		$this->render_template('orders2/index', $this->data);		
	}
	...
	public function update($id)
	{
        ...
        if ($this->form_validation->run() == TRUE) {        	
        	...
        	if(empty($orders_data)) {
        		$this->session->set_flashdata('errors', 'qweqeweqThe request data does not exists');
        		redirect('orders2', 'refresh');
        	}
