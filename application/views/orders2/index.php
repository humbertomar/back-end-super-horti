...
<script type="text/javascript">
   ...
   $(document).ready(function() {
     ...
     stringExemplo = frm.serialize();
       ...
       var saida = '0000-00-00';
       
       //console.log('https://superhorti.com.br/ws/controllers/_WS_/listarpedidosagendadosData/'+saida);
     ...
     manageTable = $('#example2').DataTable({
       ...
       'ajax': 'https://superhorti.com.br/ws/controllers/_WS_/listarpedidosagendadosData/'+saida,
       'order': []
     });
     
     manageTable = $('#example3').DataTable({
         
         "lengthMenu": [[50, 100, 200, -1], [50, 100, 200, "Todos"]],
         
       'ajax': 'https://superhorti.com.br/ws/controllers/_WS_/listarpedidosagendadosData2/'+saida,
       'order': []
     });
