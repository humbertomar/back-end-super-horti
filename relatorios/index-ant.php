...
$pedidos->campos = 'pedido_items2.name AS produto, itemId, image, count(*) as total, SUM(itemQunatity) as itemQunatitySoma';
...
$pedidos->extras_select = 'INNER JOIN pedido_items2 ON pedidos.pedido_id = pedido_items2.pedido_id WHERE DATE(data_entrega) = "'.$param.'" GROUP BY itemId ORDER BY pedido_items2.name ASC';
			   ...
			   <div class="col-xs-12 table-responsive">
				...
				?>
				  ...
				  <table class="table table-striped aligncenter">
                     ...
                     <tbody>
                        ...
                        ?>
                        <tr>
                        <th><img src="<?php echo $url.$value['image']; ?>" alt="<?php echo $value['produto']; ?>" class="img-circle" width="50" height="50"></th>
				...
				<div class="ocultar">
				  ...
				  <a download="data_123.xls" href="#" id="anchorNewApi-xls" onclick="return newApi('xls');">Exportar para Excel</a>
					...
					<?php }else{ ?>
						<h4 class="aligncenter"><strong>Não existem lançamentos para essa data!</strong></h4>
					<?php } ?>
